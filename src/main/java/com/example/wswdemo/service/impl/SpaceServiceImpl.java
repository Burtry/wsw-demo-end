...
public class SpaceServiceImpl extends ServiceImpl<SpaceMapper, Space> implements ISpaceService {
    ...
    public void updateSpace(Space spaceDTO) {
        ...
        UpdateRequest request = new UpdateRequest(IndexConstant.WSW_DEMO_TEST, String.valueOf(spaceDTO.getId()));
        request.doc("name",spaceDTO.getSpaceName(),"price",spaceDTO.getPrice(),"url",spaceDTO.getImg());
